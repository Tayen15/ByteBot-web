...
export default async function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="py-24 text-center bg-linear-to-b from-dark-secondary to-dark-primary">
        <div className="container mx-auto px-4 my-2">
          <h1 className="text-5xl md:text-7xl font-bold pb-6 text-gray-100">
            ByteBot
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="px-8 py-4 bg-discord hover:bg-discord-hover rounded-lg font-semibold text-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
            ...
            {isAuthenticated ? (
              <Link
                href="/dashboard"
                className="px-8 py-4 bg-dark-card hover:bg-dark-hover border border-border-dark rounded-lg font-semibold text-white transition-all duration-200"
              >
                <div className="flex items-center gap-2">
              ...
              <LoginButton className="px-8 py-4 bg-dark-card hover:bg-dark-hover border border-border-dark rounded-lg font-semibold text-white transition-all duration-200" />
            )}
          </div>
        </div>
      </section>
